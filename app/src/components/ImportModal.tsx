...
export const ImportModal: React.FC<ImportModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
      <div className="relative w-full max-w-md rounded border border-border bg-panel p-6 shadow-2xl">
        {/* Header */}
          ...
          {!result ? (
            <div>
              ...
              <div
                ...
                className={`flex flex-col items-center justify-center rounded border-2 border-dashed p-8 text-center cursor-pointer transition ${
                  isDragging
              ...
              {error && (
                <div className="mt-4 flex items-start gap-2 rounded bg-red-950/40 p-3 text-xs text-red-400 border border-red-800/40">
            ...
            <div className="py-2 space-y-4">
              ...
              <button
                onClick={handleClose}
                className="w-full rounded bg-accent py-2 text-xs font-semibold text-white hover:bg-accent-hover transition"
              >
                Done
              </button>
            </div>
